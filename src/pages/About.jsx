    ...
    <>
      <div className="hero">
        ...
        <p className='mb-4 text-2xl font-light'>
          Whitelist is a content curation platform that takes the best parts of YouTube and throws out the garbage.
        </p>
        </div>
      </div>
      ...
      <p>
        ...
        - Saint Thomas Aquinas, Summa Theologiae, I-II, q.94, a.2
      </p>
