    ...
    <>
      <div className="hero">
        ...
        <p className='mb-4 text-2xl font-light'>
          Whitelist is a video streaming app that restricts browsing activity to a subset of high-quality YouTube channels that adhere to Catholic moral teachings.
        </p>
        </div>
      </div>
