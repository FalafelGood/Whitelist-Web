...
function VideoCard({ video }) {
  return (
    <div className="card border border-width-1 border-neutral-300 shadow-md w-full flex flex-col hover:brightness-80 hover:bg-neutral-200 px-4 py-2 transition-all duration-100">
